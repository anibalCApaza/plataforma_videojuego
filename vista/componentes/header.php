                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown" data-bs-theme="light">
                        ...
                        <div class="dropdown-menu" aria-labelledby="themes">
                            <a class="dropdown-item" href="../cerulean/">Registrar</a>
                            <a class="dropdown-item" href="../cosmo/">Modificar</a>
                            <a class="dropdown-item" href="../cyborg/">Listar</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown" data-bs-theme="light">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="themes"
                            aria-expanded="false">Cargo</a>
                        <div class="dropdown-menu" aria-labelledby="themes">
                            <a class="dropdown-item" href="../cerulean/">Registrar</a>
                            <a class="dropdown-item" href="../cosmo/">Modificar</a>
                            <a class="dropdown-item" href="../cyborg/">Listar</a>
                    ...
                    <li class="nav-item dropdown" data-bs-theme="light">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="themes"
                            aria-expanded="false">Video Juegos</a>
                        <div class="dropdown-menu" aria-labelledby="themes">
                            <a class="dropdown-item" href="../cerulean/">Registrar</a>
                            <a class="dropdown-item" href="../cosmo/">Modificar</a>
                            <a class="dropdown-item" href="../cyborg/">Listar</a>
